...
# if options.headless:
#     options.add_argument("--height=885")
# else:
#     options.add_argument("--height=857")
if options.headless:
    options.add_argument("--window-size=1200,800")
else:
    options.add_argument("--window-size=1200,924")
# options.add_argument("--width=1200")
# service = Service(executable_path=f'{current_dir}/geckodriver', log_path=os.devnull)
...
for label in modules.foliera.parse(filepath):
